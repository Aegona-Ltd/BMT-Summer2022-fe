    ...
    public partial class CreateIdentitySchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    contact_us_id = table.Column<Guid>(type: "char(36)", nullable: false),
                    company_name = table.Column<string>(type: "longtext", nullable: false),
                    business_phone = table.Column<string>(type: "longtext", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_contact_us", x => x.contact_us_id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
